function emailHTMLConfirmation(title, prix, date, duration, adresse){
    return `
                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:20px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:center;color:#000000;">Merci pour votre inscription à l'atelier de dégustation : <strong>${title}</strong></div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:20px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;font-weight:bold;line-height:1;text-align:center;color:#000000;">Nous vous confirmons la reception du montant de <strong>${prix} €</strong> pour votre degustation </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="font-size:0px;padding:0 20px;word-break:break-word;">
...
module.exports = { emailHTMLConfirmation };
