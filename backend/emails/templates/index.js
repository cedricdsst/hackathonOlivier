function emailHTMLInscription(title, prix, date, duration, adresse){
    return `
                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:0 20px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;font-weight:bold;line-height:1;text-align:center;color:#000000;">Inscription à l'atelier : ${title} </div>
                    </td>
                  </tr>
                  <!-- Left image -->
                  <tr>
                    <td align="center" style="font-size:0px;padding:20px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:center;color:#000000;">Vous vous êtes pré-inscrit à l'atelier de dégustation suivant : <strong>${title}</strong></div>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"><strong>Adresse</strong> : ${adresse}</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="font-size:0px;padding:20px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:20px;font-weight:bold;line-height:1;text-align:center;color:#000000;">Afin de <strong>valider votre inscription</strong>, veuillez régler la somme de <strong>${prix} €</strong>.</div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="font-size:0px;padding:0 20px;word-break:break-word;">
                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;">Vous pouvez régler par Paypal à l'adresse <a href="mailto:bonnetonolivier@gmail.com">bonnetonolivier@gmail.com</a><br><br>ou via Lydia au 06 83 05 90 70</div>
                    </td>
                  </tr>
                  <tr>
...
module.exports = { emailHTMLInscription };
