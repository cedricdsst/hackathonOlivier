<template>
    <div v-if="currentAtelier">
        ...
        <div class="content-wrapper">
            <div class="info-event-card">
                ...
                <div class="event-summary mb-3">
                    <p class="inline-flex"><img src="@/assets/icons/date-svgrepo-com.svg" class="info-icon">{{
        currentAtelier.formattedStartDate }}</p><br />
                    <p class="inline-flex"><img src="@/assets/icons/clock-with-white-face_icon-icons.com_72804.svg"
                            class="info-icon">{{ currentAtelier.duration }}h</p><br />
                    <p class="inline-flex"><img src="@/assets/icons/3289574-clan-family-group-peer-people_107094.svg"
        ...
        <div class="mb-10">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipiscing elit morbi, vitae aenean cras feugiat massa etiam
                quisque mi, convallis sed nibh iaculis praesent sem lobortis. Montes phasellus non orci senectus nostra,
                dictumst bibendum magnis vivamus ridiculus scelerisque, risus blandit et torquent. Habitant sed ligula
                malesuada aptent quisque lobortis, dignissim egestas montes in nisi, lectus nibh felis rhoncus donec.
                Cum aliquet blandit euismod montes himenaeos, non aliquam libero etiam laoreet magna, erat platea
                fringilla nam. Ante magna tempor consequat ad potenti elementum pellentesque volutpat, mattis ultrices
                sagittis non interdum vestibulum venenatis id, eget lectus semper odio fusce nec lacus.</p>
        ...
        <div v-if="currentAtelier.finished" class="info-post-event">
            ...
            <div class="ressource-block">
                ...
                <hr class="divider-1 m-auto" />
                <p class="text-center">Les ressources sont protégées par mot de passe. Veuillez entrer le mot de passe
                    pour continuer :</p>
        ...
        <div v-else class="info-post-event">
            ...
            <div class="blur">
                ...
                <div class="ressource-block">
                    <h2 class="text-center">Ressources liées</h2>
                    <hr class="divider-1 m-auto" />
                    <p class="text-center">Les ressources sont protégées par mot de passe. Veuillez entrer le mot de
                        passe pour continuer :</p>
                    <input class="m-auto" type="password" placeholder="Mot de passe" />
                    <button class="red-btn">Soumettre</button>
                </div>
            </div>
