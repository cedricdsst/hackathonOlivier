...
export default {
  name: 'HomePage'
  // Vous pouvez ajouter des données, des méthodes et des composants ici si nécessaire
}
</script>
...
.hero {
  background-image: radial-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.5)), url('../assets/img/background_home_banner.jpg');
